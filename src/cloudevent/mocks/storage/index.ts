...
import {FILENAME, getBaseCloudEvent, getEventFilters, getEventType} from '../helpers';
...
export const storageV1: MockCloudEventAbstractFactory<StorageEvent> = {
  generateMock(
    ...
    const bucket = cloudEventPartial?.bucket || getEventFilters(cloudFunction)?.bucket || 'bucket_name';
